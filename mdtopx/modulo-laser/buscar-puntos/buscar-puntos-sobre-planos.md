...
Aceptando estos datos, el programa mostrará un [cuadro de diálogo](/mdtopx/otras-herramientas/calcular-plano.md) donde se pueden gestionar los puntos que definen el plano.
