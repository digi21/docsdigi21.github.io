...
Al finalizar una línea \(independientemente del método utilizado para finalizarla como pulsar el botón de _Reset_, ejecutar la orden [FIN\_ENT](FIN_ENT.html) o la orden [CIERRA\_ENT](CIERRA_ENT.html)\), si está activada la variable booleana **S**, la línea se suavizará antes de ser almacenada en el archivo de dibujo.
