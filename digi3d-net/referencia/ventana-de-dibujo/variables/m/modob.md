...
Si nos encontramos la situación de tener activado el modo de búsqueda 12 y tenemos que tentativar en una entidad en la cual la Z no es coincidente, en este caso se admite ejecutar la orden [MODOB](/digi3d-net/referencia/digi3d.net/ventana-de-dibujo/variables/m/MODOB.html) con un tipo de modo de búsqueda secundario secundario.
...
| Variables relacionadas | [REPITE](/digi3d-net/referencia/digi3d.net/ventana-de-dibujo/variables/m/REPITE.html) |
